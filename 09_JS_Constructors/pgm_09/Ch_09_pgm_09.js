...
var library = new Place("The Old Library","You are in a library.Dusty books line the walls.");
...
var player2 = new Player("Dax", 40);
player2.place = library;
player2.addItem("a healing potion");
player2.addItem("a silver dagger");

player1.showInfo("=");
player2.showInfo("-");

//testing dropLastItem method
